...
grep "%" yw/dlv/run_log_queries.txt

# reason out the result of one of the queries:
./dlv.i386-linux-elf-static.bin yw/dlv/log_queries.dlv yw/dlv/extractfacts.dlv yw/dlv/modelfacts.dlv yw/dlv/validatefacts.dlv -filter=lq5
